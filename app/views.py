        ...
        if form.is_valid():
            ...
            if not driver_list:
                ...
                if not driver_list:
                    ...
                    send_mail(subject2, message2, 'shipra112k@gmail.com',[driver_list[0].email])
    ...
    if request.method=='POST':
        if driver.status=='Free' or driver.status=='Absent':
            ...
            if not orders:
                ...
                send_mail(subject, message, 'shipra112k@gmail.com',[orders[0].email])
                subject2 = "Next Journey"
                ...
                send_mail(subject2, message2, 'shipra112k@gmail.com',[orders[0].email])
...
def contact(request,pk):
    if request.method=="POST":
        ...
        # send_mail(subject, message, 'shipra112k@gmail.com',[enquirer.email])
